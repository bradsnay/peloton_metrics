...
from peloton_metrics.processors.track_new_user_processor import TrackNewUserProcessor
...
track_new_user_processor = TrackNewUserProcessor()
track_new_user_processor.track_new_user('elizabethassaf')
